...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card">
                <div class="card-header bg-warning login100-form-title">Admin {{ __('Register') }}</div>
                <br>
                <br>
                <br>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" placeholder="Masukan Username"class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="email" type="email" placeholder="Masukan Email"class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
